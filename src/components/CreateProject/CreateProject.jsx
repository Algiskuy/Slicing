              ...
              <div className="sm:flex justify-between flex-wrap">
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label className="ml-2" htmlFor="kesehatan">
                      Kesehatan
                    </label>
                  </div>
                </div>
                <div>
                  <div className="my-2 flex items-center">
                    ...
                    />
                    <label className="ml-2" htmlFor="perdagangan">
                      Perdagangan
                    </label>
                  </div>
                  <div className="flex items-center">
                ...
                <div className="w-1/3 ">
                  ...
                  <div>
                    <input
                      ...
                      className="input-field px-2 border-b-[1px] w-full border-b-black  bg-transparent outline-none"
                    />
                  </div>
                </div>
              </div>
